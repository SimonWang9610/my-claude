...
Grep/read recipes and before→after examples for Pass 3. Targets React 19 + Vitest + RTL + Zustand + TanStack Query v5. Grep commands narrow where to read — confirm every hit by reading the file.
