...
- **Descriptions fit the listing.** A skill/agent `description` stays well under the 1,536-char listing cap — capability + triggers front-loaded, so truncation can never eat the routing signal.
