...
| `../fl-architecture-gate/references/gate-procedure.md` | Architecture gate procedure + PASS/FAIL formats |
...
| `../../rules/engineering-discipline.md` | Discipline rules (scope, surgical changes) |
