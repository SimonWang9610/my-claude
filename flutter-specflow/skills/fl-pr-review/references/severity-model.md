...
| Scope creep: significant code changed outside the named AC's scope (unrequested refactor, speculative feature) | — | `../../rules/engineering-discipline.md` |
...
| Pre-existing dead code adjacent to (but not created by) the diff — mention, do not delete | — | `../../rules/engineering-discipline.md` |
| Non-surgical reformatting of unchanged lines (whitespace, unrelated renames) | — | `../../rules/engineering-discipline.md` |
