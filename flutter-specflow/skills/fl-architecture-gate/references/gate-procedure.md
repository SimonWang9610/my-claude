# Gate procedure — fl-architecture-gate
...
3. **Check against bundled rules in priority order.** Read the specific rule file in `../../fl-architecture-design/references/core/`
   ...
   `../../fl-architecture-design/references/principle-checks.md`. Do not cite a rule from memory — confirm against the file's
   incorrect/correct examples. When a clear performance hazard is visible, also consult the
   `../../fl-architecture-design/references/conditional/performance/` pack (non-blocking).
...
**Confirm against:** `../../fl-architecture-design/references/core/widget-build-discipline.md`,
...
**Confirm against:** `../../fl-architecture-design/references/core/layering-and-structure.md`,
...
**Confirm against:** `../../fl-architecture-design/references/core/testability-seam.md`,
...
> `../../fl-architecture-design/references/conditional/performance/` and note it
...
Rule confirmed against: ../../fl-architecture-design/references/core/<name>.md (or .../conditional/...)
...
- Define the target architecture principles (those are P1–P8 in `../../fl-architecture-design/references/principle-examples.md`).
